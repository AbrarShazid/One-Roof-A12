...
import banner1Avif from "../../assets/1.avif";
import banner2Avif from "../../assets/2.avif";
import banner3Avif from "../../assets/3.avif";
import banner4Avif from "../../assets/4.avif";
      ...
      >
        {slides.map((slide) => (
          <SwiperSlide key={slide.id} className="relative">
            ...
            <picture>
              <source srcset={slide.image} type="image/avif" className="w-full h-full object-cover" />
              <img
                src={slide.imageBackup}
                alt={slide.title}
            ...
            <div className="absolute inset-0 z-20 grid md:grid-cols-2 items-center   px-6 md:px-12 lg:px-16 gap-6 py-6 md:py-8  lg:py-12 ">
              ...
              <div className="text-white space-y-2 md:space-y-3 lg:space-y-6  flex flex-col justify-between  ">
                ...
                <h4 className="text-xl text-[#bed4d1] md:text-2xl lg:text-4xl font-semibold opacity-90">
                  {slide.subtitle}
                </h4>
                <p className="opacity-90 text-white lg:text-2xl">
                  {slide.description}
                </p>
                ...
                <Link
                  to={"/apartments"}
                  className="w-max my-3 px-6 py-2 rounded-full bg-white text-black hover:bg-[#142921] hover:text-[#bed4d1] font-semibold hover:scale-105 transition duration-300 shadow-md"
                >
                  Explore Apartments
                </Link>
              </div>
              ...
              <div className="hidden md:grid grid-cols-2 gap-4 lg:gap-6 w-[100%]">
                {stats.map((stat, i) => (
                  ...
                  >
                    ...
                    <div className="text-xl font-bold text-[#bed4d1]">
                      {stat.value}
                    </div>
