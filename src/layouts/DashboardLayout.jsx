        ...
        <div className="flex flex-col justify-center items-center gap-2">
          <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 xl:w-32 xl:h-32 rounded-full overflow-hidden border border-[#e4edec]">
            <img
              ...
              src={getCloudinaryImage(user.photoURL, 400) || dummyPic}
              alt="User"
            />
          </div>
          <div className="text-center mb-2">
            <h1 className="text-lg sm:text-xl lg:text-2xl xl:text-3xl font-semibold break-words">
              {user.displayName}
            </h1>
            <h3 className="text-xs sm:text-sm lg:text-base break-all">
              {user.email}
            </h3>
          </div>
        </div>
      ...
      <main className="w-full lg:ml-[20%] lg:w-4/5 min-h-screen">
        ...
        <div className="sticky top-0 bg-[#e4edec] shadow-md z-200 px-4 lg:px-6 py-4 border-b border-[#c7d4d3]">
          {role === "admin" && (
            <Link
              to={"/dashboard"}
              className="text-base md:text-xl font-semibold text-[#142921] ml-12 lg:ml-0"
            >
              Admin Dashboard
            </Link>
          )}
