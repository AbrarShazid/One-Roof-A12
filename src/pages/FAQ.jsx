  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Yes, but early termination fees may apply depending on how far in advance you cancel. You can request cancellation from your Dashboard → Agreements section, which requires admin approval."
      }
    ]
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Submit a maintenance request through email."
      },
      {
...
const FAQItem = ({ question, answer, isOpen, onClick }) => {
  return (
    <motion.div 
      className="border border-base-300 rounded-xl overflow-hidden mb-4"
      initial={false}
      animate={{ backgroundColor: isOpen ? "#f8faf9" : "white" }}
    ...
    >
      ...
      <AnimatePresence initial={false}>
        {isOpen && (
          ...
          >
            <div className="px-5 pb-5 text-base text-base-content/80 leading-relaxed">
              {answer}
            </div>
          </motion.div>
        )}
